...
export const Subscribe = ({subscribe}) => {
  return (
    <div className='lg:mx-32 md:mx-10 mx-6 mb-24'>
        <div className="subscribe-section md:flex block lg:space-x-20 md:space-x-6 space-x-0 items-center">
            <img src={require('../assets/'+subscribe.image)} alt="" className='lg:w-[70%] md:w-[50%]'/>
            {/* Content */}
            <div>
                <h2 className='font-head lg:text-[4rem] font-bold md:text-[2.8rem] text-[2.5rem] pb-2'>{subscribe.title}</h2>
                <p className='text-[.9rem] lg:w-[70%] text-content'>{subscribe.content}</p>
                {/* Subscribe */}
