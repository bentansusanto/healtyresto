        ...
        <div className="subscribe-section md:flex block lg:space-x-20 md:space-x-6 space-x-0 items-center">
            ...
            <div>
                ...
                <div className='mt-5 flex lg:space-x-3 space-x-2'>
                    <input type="text" placeholder='Enter your name'className='py-5 px-5 text-[.9rem] placeholder:text-[.9rem] shadow-md bg-[#FAFAFA] md:w-auto rounded-md outline-none'/>
                    <button className='bg-primary text-second py-5 px-8 text-center rounded-md font-semibold md:w-[50%]'>
                        <Link to='/'>
                            Get
                        </Link>
                    </button>
